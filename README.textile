...
h2{color:#990033}. I'm about to upgade mongoid_tree to support Mongoid 2.0.0.rc.1. All suggestions are very welcome. Now is the time!

p{color:#990033}. What will be done so far:

#{color:#990033} Custom association names. Was so far locked to parent/children
# Relational or Embedded association
